document.addEventListener("DOMContentLoaded", function() {
    ...
    doneButton.addEventListener("click", function() {
        ...
        var countrySelect = document.querySelector('.form__counrty');
        ...
        if (allFieldsFilled) {
            ...
            var street = document.querySelector('.form__steer').value;
            ...
            var country = document.querySelector('.form__counrty').value;
    ...
    changeButton.addEventListener('click', function() {
        ...
        document.querySelector('.form__steer').value = document.querySelector('.data__street').innerText;
        ...
        document.querySelector('.form__counrty').value = document.querySelector('.data__country').innerText;
